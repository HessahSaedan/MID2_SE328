...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    */
    ...
    public Cursor getSpecificProduct(String surname){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor data = db.rawQuery("SELECT * FROM " + TABLE_NAME+" where Surname=\""+surname+"\"",null);
        return data;
    }
    ...
    public boolean deleteData(String nationalid) {
        SQLiteDatabase db = this.getWritableDatabase();
        return db.delete(TABLE_NAME, COL1 + "=" + nationalid, null) > 0;
    }
